...
const mockSseBody = [
  ...
  '',
  'data: {"type":"agent_start","agentId":"orchestrator","label":"需求拆解","status":"running","progress":12,"message":"开始拆解用户需求并生成检索参数"}',
  '',
  'data: {"type":"agent_done","agentId":"orchestrator","label":"需求拆解","status":"completed","progress":100,"message":"已完成当前阶段处理"}',
  '',
  'data: {"type":"agent_start","agentId":"attraction_agent","label":"景点 Agent","status":"running","progress":12,"message":"景点 Agent已开始处理"}',
  '',
  'data: {"type":"agent_start","agentId":"hotel_agent","label":"酒店 Agent","status":"running","progress":12,"message":"酒店 Agent已开始处理"}',
  '',
  'data: {"type":"agent_start","agentId":"weather_agent","label":"天气 Agent","status":"running","progress":12,"message":"天气 Agent已开始处理"}',
  '',
  'data: {"type":"agent_result","agentId":"weather_agent","label":"天气 Agent","status":"running","progress":86,"counts":{"days":1}}',
  '',
  ...
  '',
  'data: {"type":"agent_done","agentId":"weather_agent","label":"天气 Agent","status":"completed","progress":100,"message":"已完成当前阶段处理","counts":{"days":1}}',
  '',
  'data: {"type":"agent_result","agentId":"attraction_agent","label":"景点 Agent","status":"running","progress":86,"counts":{"items":2}}',
  '',
  ...
  '',
  'data: {"type":"agent_done","agentId":"attraction_agent","label":"景点 Agent","status":"completed","progress":100,"message":"已完成当前阶段处理","counts":{"items":2}}',
  '',
  'data: {"type":"agent_result","agentId":"hotel_agent","label":"酒店 Agent","status":"running","progress":86,"counts":{"items":1}}',
  '',
  'data: {"type":"hotels","data":[{"name":"王府井艺术酒店","address":"北京王府井","hotel_level":"舒适型","rating":4.5}]}',
  '',
  'data: {"type":"agent_done","agentId":"hotel_agent","label":"酒店 Agent","status":"completed","progress":100,"message":"已完成当前阶段处理","counts":{"items":1}}',
  '',
  'data: {"type":"agent_start","agentId":"reviewer_agent","label":"评审 Agent","status":"running","progress":12,"message":"评审 Agent已开始处理"}',
  '',
  'data: {"type":"agent_done","agentId":"reviewer_agent","label":"评审 Agent","status":"completed","progress":100,"message":"已完成当前阶段处理","counts":{"attractions":2,"hotels":1}}',
  '',
  'data: {"type":"agent_start","agentId":"restaurant_agent","label":"餐饮 Agent","status":"running","progress":12,"message":"餐饮 Agent已开始处理"}',
  '',
  'data: {"type":"agent_result","agentId":"restaurant_agent","label":"餐饮 Agent","status":"running","progress":86,"counts":{"items":1}}',
  '',
  'data: {"type":"restaurants","data":[{"name":"四季民福","type":"dinner","description":"北京烤鸭","rating":4.6}]}',
  '',
  'data: {"type":"agent_done","agentId":"restaurant_agent","label":"餐饮 Agent","status":"completed","progress":100,"message":"已完成当前阶段处理","counts":{"items":1}}',
  '',
  'data: {"type":"agent_start","agentId":"transport_agent","label":"交通 Agent","status":"running","progress":12,"message":"交通 Agent已开始处理"}',
  '',
  'data: {"type":"agent_result","agentId":"transport_agent","label":"交通 Agent","status":"running","progress":86,"counts":{"days":1}}',
  '',
  'data: {"type":"agent_done","agentId":"transport_agent","label":"交通 Agent","status":"completed","progress":100,"message":"已完成当前阶段处理","counts":{"days":1}}',
  '',
  'data: {"type":"agent_start","agentId":"final_planning","label":"成稿 Agent","status":"running","progress":12,"message":"成稿 Agent已开始处理"}',
  '',
  ...
  '',
  'data: {"type":"agent_done","agentId":"final_planning","label":"成稿 Agent","status":"completed","progress":100,"message":"已完成当前阶段处理","counts":{"days":1,"attractions":2}}',
  '',
  'data: {"type":"done"}',
  '',
].join('\n')
